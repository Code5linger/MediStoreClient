...
//         `${process.env.NEXT_PUBLIC_BETTER_AUTH_URL}/api/auth/sign-out`,
//         {
//           method: 'POST',
//           headers: {
...
import Link from 'next/link';
import { ShoppingCart, User, LogOut, Pill, Plus, Package } from 'lucide-react';
import { useCartStore } from '@/store/cart';
import { useSession } from '@/lib/auth-client';
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            {session?.user?.role === 'SELLER' && (
              <>
                ...
                <Link
                  href="/seller/dashboard?addNew=true"
